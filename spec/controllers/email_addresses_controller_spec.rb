...
RSpec.describe EmailAddressesController, :type => :controller do
  ...
  let(:jeff) {Person.create(first_name: "Jeff", last_name: "Wan")}

  # This should return the minimal set of attributes required to create a valid
  # EmailAddress. As you add validations to EmailAddress, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) {
    { address: "Jwan622@gmail.com", person_id: jeff.id}
  }
  ...
  describe "POST create" do
    describe "with valid params" do
      let(:jeff) {Person.create(first_name: "Jeff", last_name: "Wan")}
      let(:valid_attributes) {{address: "Jwan622@gmail.com", person_id: jeff.id}}
      ...
      it "redirects to the created email_address" do
        post :create, {:email_address => valid_attributes}, valid_session   #ask what this does, why does params need to be nested?
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      let(:new_attributes) {{ address: "Jwan622@yahoo.com", person_id: jeff.id}}
      ...
      it "updates the requested email_address" do
        ...
        expect(email_address.address).to eq('Jwan622@yahoo.com')
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the email_addresses list" do
      email_address = EmailAddress.create! valid_attributes
      delete :destroy, {:id => email_address.to_param}, valid_session
      expect(response).to redirect_to(person_path(jeff.id))
    end
  end
